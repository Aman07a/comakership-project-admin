    ...
    <div class="main-container">
        <div class="main">
            <div class="navbar">
                ...
                <div class="account">
                    @guest
                        <div class="hidden md:flex items-center space-x-2 mr-2 ml-1">
                            @if (Route::has('login'))
                                <a href="{{ route('login') }}"
                                    class=" font-semibold py-2 px-3 rounded text-white view-link">Login</a>
                            @endif
                            @if (Route::has('register'))
                                <a href="{{ route('register') }}"
                                    class="font-semibold py-2 px-3 rounded text-white view-link">Register</a>
                            @endif
                        </div>
                    @else
                        <div class="hidden md:flex items-center space-x-2 mr-2">
                            ...
                            <div id="dropdownDivider"
                                class="hidden z-10 w-44 text-base list-none bg-white rounded divide-y divide-gray-100 shadowdropdown-inset">
                                <ul class="py-2" aria-labelledby="dropdownDividerButton">
                                    <li>
                                        <a href="#"
                                            class="block py-2 px-4 text-sm text-black hover:bg-yellow-400">Profile</a>
                                    </li>
                                </ul>
                                <div class="py-1">
                                    <a href="{{ route('logout') }}"
                                        class="block py-2 px-4 text-sm text-black hover:bg-yellow-400"
