    ...
    <div class="main-container h-screen">
        <div class="main">
            <div class="sidebar">
                <div class="logo">
                    <div class="kolibri">
                        <a href="{{ url('/') }}" class="flex items-center py-3.5 px-2 text-white kolibri-link">
                            <img class="h-12 w-12 mr-1 text-blue-400 invert-logo icon"
                                src="{{ asset('images/kolibri.png') }}">
                            <span class="font-bold logo_name">Kolibri-API</span>
                        </a>
                    </div>
                    <i class="collapse bx bx-menu flex items-center py-7 px-2 text-white" id="btn"></i>
                </div>
                    ...
                    @else
                        <div class="hidden md:flex items-center space-x-1 mr-4">
                            <button id="dropdownDividerButton" data-dropdown-toggle="dropdownDivider"
                                class="text-white font-medium rounded-lg text-xl py-2 px-3 text-center inline-flex items-center"
            ...
            <div class="mobile-content overflow-auto">
                @yield('content')
            </div>
        </div>
    </div>
