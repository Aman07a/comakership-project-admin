...
@section('content')
    ...
    <div class="col-span-3 w-full h-screen">
        ...
        <form class="user-validation flex justify-center" action="{{ route('user.profile.update') }}"
            method="POST">
            @csrf
            <div class="p-10 grid grid-cols-1 gap-5 w-3/4">
                <div class="font-bold text-xl mb-2">Profile: {{ $user->name }}</div>
                <div class="flex">
                    <div class="md:w-1/2">
                ...
                <div class="flex">
                    <div class="md:w-1/2">
                        ...
                        <input type="text"
                            class="appearance-none block w-full bg-gray-200 text-black rounded py-3 px-4 leading-tight @error('name') is-invalid @enderror"
                            name="phone_number" value="{{ $user->phone_number }}" placeholder="00-00000000" required
                    ...
                    <div class="md:w-1/2 ml-3">
                        ...
                        <input type="text"
                            ...
                            name="alternate_phone_number" value="{{ $user->alternate_phone_number }}"
