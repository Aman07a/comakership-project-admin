                                ...
                                <tr tabindex="0"
                                    ...
                                    <td class="col-span-2">
                                        <p
                                            ...
                                            {{ $property->street }} {{ $property->house_number }}, {{ $property->zipcode }}
                                            {{ $property->city }}
                                        </p>
                                    </td>
                                    <td class="col-span-1">
